...
public class PostDetailActivity extends AppCompatActivity {
    ...
    private Uri saveImageToShare(Bitmap bitmap) {
        ...
        try {
            ...
            stream.flush();
            stream.close();
            uri = FileProvider.getUriForFile(this, "com.example.social",
                    file);
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot ds: dataSnapshot.getChildren()){
                    ...
                    adapterComments = new AdapterComments(getApplicationContext(), commentList, commentList, myUid, postId);
    ...
    private void deleteWhithoutImage() {
        ...
        ref.child(timeStamp).setValue(hashMap)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        addToHisNotifications(""+hisUid, ""+postId, " Comment your post");
    ...
    private void updateComentCount() {
